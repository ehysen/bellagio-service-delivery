...
| **Agentic Government Protocol** | An open standard for programmatic service-delivery flows between constituents, their agents, intermediaries, and government — the "rails." Modeled on the [Agentic Commerce Protocol](https://www.agenticcommerce.dev). | Separate repo | **[agentic-government-protocol.vercel.app](https://agentic-government-protocol.vercel.app)** |
| **Vision prototype** | A dynamic prototype and pitch that demonstrates the end-to-end vision — the artifact you fundraise and align states on. | Code TBD | **[rainbow-sherbet-5d5509.netlify.app](https://rainbow-sherbet-5d5509.netlify.app)** |
| **MCP example** | A reference MCP server for a government-benefit lookup — showing how a state exposes a service to agents instead of hand-rolling integrations. | — | _Coming soon_ |
